...
from gslides_api.slide import Slide, SlideProperties, Layout
...
slide = Slide(
    ...
    pageProperties=PageProperties(
        ...
        colorScheme=ColorScheme(
            colors=[
                ThemeColorPair(
                    type=ThemeColorType.DARK1,
                    color=RgbColor(red=0.0, green=0.0, blue=0.0)
                ),
                ThemeColorPair(
                    type=ThemeColorType.LIGHT1,
...
layout = Layout(
    ...
    layoutProperties={"masterObjectId": "test-master-id", "name": "Test Layout", "displayName": "Test Layout"},
