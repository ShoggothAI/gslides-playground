...
class TestPageBackgroundFill(unittest.TestCase):
    def test_solid_fill_background(self):
        ...
        background_fill = PageBackgroundFill(
            propertyState=PropertyState.RENDERED,
    ...
    def test_stretched_picture_fill_background(self):
        ...
        size = Size(
            width=SizeWithUnit(magnitude=100, unit="PT"),
            height=SizeWithUnit(magnitude=200, unit="PT")
        )
        ...
        background_fill = PageBackgroundFill(
            propertyState=PropertyState.RENDERED,
            stretchedPictureFill=stretched_picture
        )
        ...
        self.assertEqual(api_format["stretchedPictureFill"]["contentUrl"], "https://example.com/image.jpg")
